...
def scraper():
    with sync_playwright() as p:
        ...
        # Select SEBI
        ministry_dropdown.select_option("78")
        print('Successfully selected IRDAI')
        ...
        download.save_as('downloads/irdai_standard_report.pdf')
        print("IRDAI Standard Report downloaded")
